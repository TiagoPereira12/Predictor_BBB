...
def read_files():
    ...
    for file in ["BBBP", "ci600312d_si_001","ci034205dsi20031027_054116","1-s2.0-S1093326319303547-mmc2", "ao9b01512_si_002", "ao9b01512_si_003"]:
                ...
                if file == "BBBP":
                    ...
                    try:
                        ...
                        if smi not in unique_mols and len(s)<65:
                            ...
                            print(smi)
                            print('ERROR: Invalid SMILES!Não')  
                            
                elif file == "ao9b01512_si_002":
                    l = l.strip().split(';')
                    if idx > 0:
#                    if idx > 0 and l[0] == "0":
                        smi = l[47]
                        try:
                            ...
                            if smi not in unique_mols and len(s)<65:
                                ...
                                unique_labels.append(str(l[0]))
                        except:
                                print(smi)
                                print('ERROR: Invalid SMILES!')  

                elif file == "ao9b01512_si_003":
                    l = l.strip().split(';')
                    if idx > 0:
#                    if idx > 0 and l[0] == "0":
                        smi = l[47]
